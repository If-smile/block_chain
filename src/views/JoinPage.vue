  ...
  <div class="join-page">
    <el-container>
      <el-header class="header">
        ...
        <p>Scan QR code or enter Session ID to join consensus</p>
      </el-header>
          ...
          <div v-if="sessionInfo" class="session-details">
            ...
            <div class="auto-assign-section">
              <div class="assign-info">
                ...
                <p>The system will auto-assign an available node; no manual selection needed.</p>
              ...
              <div class="join-actions">
                ...
                >
                  {{ sessionInfo.nodeCount === connectedNodes.length ? 'All nodes occupied' : 'Auto-assign & Join' }}
                </el-button>
...
export default {
  ...
  setup() {
    ...
    const getNodePermissions = (nodeId) => {
      if (nodeId === 0) return 'Propose and participate in consensus'
      return 'Participate in consensus and vote'
    }
    
    const getNodeResponsibilities = (nodeId) => {
      if (nodeId === 0) return 'Initiate proposals, coordinate nodes'
      return 'Verify proposals, send prepare and commit messages'
    }
    ...
    const autoAssignAndJoin = async () => {
      ...
      try {
        ...
        if (error.response?.status === 409) {
          ElMessage.error('All nodes occupied, please try again later')
        } else {
